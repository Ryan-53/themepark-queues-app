...
class RideModelTest(TestCase):
  ...
  def test_ride_creation(self):
    ...
    self.assertEqual(self.ride.type, "Thrills")
  ...
  def test_type_field_constraints(self):
    """Tests the type field for length constraints"""
    max_length = Ride._meta.get_field('type').max_length
    self.assertEqual(max_length, 255)
